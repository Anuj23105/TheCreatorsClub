    ...
    >
      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="mt-4 flex flex-wrap gap-2 text-xs text-slate-600 dark:text-slate-300">
          <span className="rounded-full bg-slate-100 px-3 py-1 dark:bg-slate-800">{worker.experienceYears}+ yrs</span>
          <span className="rounded-full bg-slate-100 px-3 py-1 dark:bg-slate-800">{worker.completedJobs} jobs</span>
          <span className="rounded-full bg-slate-100 px-3 py-1 dark:bg-slate-800">Starting Rs {worker.fee}</span>
        </div>
