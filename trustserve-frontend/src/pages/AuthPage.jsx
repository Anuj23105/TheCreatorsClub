...
function AuthPage() {
  ...
  return (
    <main className="mx-auto grid w-full max-w-7xl gap-6 px-4 py-8 sm:px-6 lg:grid-cols-2 lg:px-8">
      ...
      <section className="glass-card rounded-3xl p-6 sm:p-8">
        <h2 className="text-2xl font-bold">Secure, role-based access</h2>
        <ul className="mt-4 space-y-2 text-sm text-slate-600 dark:text-slate-300">
          <li>Customer flows for quick booking and reviews</li>
          <li>Worker flows are now enabled with live JWT login/logout state</li>
          <li>Both customer and worker dashboard routes are protected</li>
        </ul>
